...
@Component({
  selector: "app-rooms",
  standalone: true,
  imports: [RoomComponent, MatGridListModule],
...
export class RoomsComponent {
  ...
  // But since we are sending the data to the child through async pipe, when we get it in the child, it's not an observable, but Room[]
  rooms = input<Room[]>([]);
  breakpoint: number = 0;
